...
class ReportController:
    ...
    def display_tournament_players_alphabetically(self):
        ...
        report_text = []
        tournament_player_alpha_report = tournament_controller.TournamentController()
        tournament_player_alpha_report.display_tournament_alphabetically()
        for tournament in tournament_player_alpha_report:
